    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.CharField(blank=True, choices=[('SUCCESS', 'تراکنش موفق'), ('FAILED', 'تراکنش ناموفق')],
                ...
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                            related_name='transactions', to='order_management.order')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(condition=models.Q(('status', 'SUCCESS')), fields=('order',),
